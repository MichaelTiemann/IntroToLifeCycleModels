...
% Notice change to 'LifeCycleModelV2_ReturnFn'
ReturnFn=@(h,aprime,a,w,sigma,psi,eta,agej,Jr,pension)...
    LifeCycleModelV2_ReturnFn(h,aprime,a,w,sigma,psi,eta,agej,Jr,pension);
...
% Obviously now that we have added retirement no-one works during retirement.
...
% so we use PolicyInd2Val_FHorz() to convert them into the actual h values.
figure(2)
