...
% Like with return function, we have to include (riskyshare,savings,hprime,h,a,z) as first inputs, then just any relevant parameters.
...
FnsToEvaluate.housing=@(riskyshare,savings,hprime,h,a,z) h; % h is the current housing
