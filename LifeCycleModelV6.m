%% Life-Cycle Model 6: Chance of dying
% Introduce 'conditional probability of survival' sj
% sj appears as a discount factor in DiscountFactorParamNames
% Also modify the 'mewj' so that fraction of population of each age reflects sj
...
n_a=701; % Endogenous asset holdings
